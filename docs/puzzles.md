**5,600,086** chess puzzles, rated, and tagged. [See them in action on Lichess](https://lichess.org/training/themes).

[Download lichess_db_puzzle.csv.zst](https://database.lichess.org/lichess_db_puzzle.csv.zst)
